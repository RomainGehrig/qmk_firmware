...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_1,    KC_2,    KC_3,    KC_4,    _______,
...
[_ADJUST] = LAYOUT_preonic_grid(
  RGB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_SLEP,
  RGB_MOD, RESET,   DEBUG,   _______, _______, _______, _______, TERM_ON, TERM_OFF,_______, _______, _______,
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, KC_VOLU, KC_VOLD, KC_MPRV, KC_MNXT, _______,
  _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  KC_MPRV, KC_MNXT, _______, _______, _______,
